...
export function Footer() {
  ...
  return (
    <footer className='mt-18 py-13 pb-14 gap-5 bg-grey flex flex-col justify-center items-center'>
      <Image src={Logo} alt='Journey Bites' className='object-cover object-center w-[200px] sm:w-[240px] md:w-[240px] lg:w-[245px] xl:w-[250px]' priority onContextMenu={onContextMenuHandler} />
      <Image src={CurveLine} alt='curve' className='mt-[-6px] mb-3 lg:mb-3.5' onContextMenu={onContextMenuHandler} priority />
