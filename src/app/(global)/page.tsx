      ...
      <div className='mx-auto max-w-1320'>
        <div className='grid'>
          <div className='grid grid-cols-12 md:px-3 lg:px-3 xl:px-3 2xl:px-3'>
            <div className='sm:col-span-12 sm:mt-9 md:col-span-12 md:mt-9 lg:col-span-8 lg:mt-20 xl:col-span-8 xl:mt-20 2xl:col-span-8 2xl:mt-20 xs:col-span-12 xs:mt-9'>
              <Content />
            </div>
